 ...
 */
@RestController
@RequestMapping("/api/statistic/discount")
public class ApiDiscountSalesStatisticController extends BaseController{
    /**
    ...
    public ApiResponse get(@RequestParam Map<String, String> params) throws ApiException{
        try{
            ...
            return new ApiResponse(salesStatisticService.getDiscountSalesSummaries(filter));
        }catch(Exception ex){
            throw WebHelper.logException(getLogger(),
                    ApiDiscountSalesStatisticController.class.getName()
